...
export const TESTIMONIALS = [
  {
    ...
    role: 'CEO',
    content: 'Tara InfoTech delivered an exceptional web application that exceeded our expectations. Their attention to detail and technical expertise is unmatched.',
    rating: 5,
  ...
  },
  {
    ...
    role: 'CTO',
    content: 'Professional, reliable, and innovative. Tara InfoTech transformed our digital presence and helped us scale our business significantly.',
    rating: 5,
